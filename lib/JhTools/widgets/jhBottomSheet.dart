           ...
           showModalBottomSheet(
              ...
              builder: (BuildContext context){
                ...
                SafeArea(
                  ...
                  Container(
                    color: Colors.white,
                    height: _cellHeight*(_dataArr.length+1)+(_dataArr.length-1)*1+_spaceHeight+titleHeight+titltLineHeight,
                    child: Column(
                      children: <Widget>[

                        Container(
                            height: titleHeight,
                            child: Center(child: Text(title??"",style: TextStyle(fontSize: _titleFontSize,color: _titleColor),textAlign: TextAlign.center))
                        ),
                        SizedBox(height: titltLineHeight,child: Container(color: _spaceColor)),
                        ...
                        ListView.separated(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            ...
                            Color _btnTextColor = (redBtnTitle!=null&&index == _dataArr.length-1)?_red_textColor:_textColor;
                            ...
                            return
                              GestureDetector(
                                child:  Container(
                                    ...
                                    child:
                                    Center(
                                        child:Text(_dataArr[index],style: TextStyle(fontSize: _textFontSize,color: _btnTextColor),textAlign: TextAlign.center)
                                    )
                                ),
                        ...
                        GestureDetector(
                          child: Container(
                              height: _cellHeight,
                              color: Colors.white,
                              child: Center(child: Text("取消",style: TextStyle(fontSize: _textFontSize,color: _textColor),textAlign: TextAlign.center))
                          ),
                          onTap: (){
                            clickCallback(0,"取消");
