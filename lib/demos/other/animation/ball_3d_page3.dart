...
class Ball3DPage3 extends StatefulWidget {
  const Ball3DPage3({Key? key}) : super(key: key);

  @override
  State<Ball3DPage3> createState() => _DBallPage3State();
}

class _DBallPage3State extends State<Ball3DPage3> {
  double rpm = 3;

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const BaseAppBar('3D球 - 文字'),
      body: Center(
