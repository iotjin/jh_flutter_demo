...
class KColors {
  ...
  static const Color kTagWarningColor = Color(0xFFFFBA00);
  static const Color kTagErrorColor = Color(0xFFFF4949);
  static const Color kTagSuccessColor = Color(0xFF13CE66);
